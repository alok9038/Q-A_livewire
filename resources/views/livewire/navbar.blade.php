        ...
        <div class="container">
            ...
            <form action="" method="get">
                <div class="input-group border-muted border" style="border-radius: 8px;">
                    ...
                    <button class="btn bg-white btn-sm " style="border-radius: 0px 8px 8px 0px;"><i class="fa fa-search"></i></button>
                </div>
            </form>
            <ul class="navbar-nav">
                <li class="nav-item">
                ...
                <li class="nav-item ms-5"  >
                    <a href="#" class="nav-link ">
                        <i class="fa fa-edit fa-2x" style="font-size: 24px;"></i>
                    </a>
                </li>
                <li class="nav-item ms-5 ">
                    <a href="#" class="nav-link ">
                        <i class="fa fa-users fa-2x" style="font-size: 24px;"></i>
                        {{-- <span class="p-1">Home</span> --}}
                    </a>
                </li>
                <li class="nav-item ms-5 pt-1">
                    <a href="#addQuestion" data-bs-toggle="modal" data-bs-target="#addQuestion" class="btn btn-sm btn-danger mt-1" style="border-radius: 25px;">Add question</a>
                </li>
            </ul>
        </div>
    </nav>
